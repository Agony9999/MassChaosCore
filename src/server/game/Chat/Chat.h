...
class ChatHandler
{
    public:
        ...
        void RedSystemMessageToPlr(Player* player, const char *message, ...);
        void GreenSystemMessageToPlr(Player* player, const char *message, ...);
        void BlueSystemMessageToPlr(Player* player, const char *message, ...);
