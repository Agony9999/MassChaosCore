...
snprintf(msg, 1024,"%s%s|r", "|cffff6060", msg1);
FillSystemMessageData(&data, msg);
m_session->SendPacket(&data);
delete &data;
}
...
snprintf(msg, 1024, "%s%s|r", "|cff00ff00", msg1);
FillSystemMessageData(&data, msg);
m_session->SendPacket(&data);
delete &data;
}
...
snprintf(msg, 1024,"%s%s|r", "|cff00ccff", msg1);
FillSystemMessageData(&data, msg);
m_session->SendPacket(&data);
delete &data;
}
...
bool ChatHandler::ShowHelpForSubCommands(ChatCommand* table, char const* cmd, char const* subcmd)
{
    ...
    for (uint32 i = 0; table[i].Name != NULL; ++i)
    {
		...
		{
			case 1:
				list = list + "|cff00FFFF" + table[i].Name + "|cffFFFF00, ";
				break;
			case 2:
				list = list + "|cff00FF00" + table[i].Name  + "|cffFFFF00, ";
				break;
			case 3:
				list = list + "|cffFF0000" + table[i].Name  + "|cffFFFF00, ";
				break;
			default:
				list = list + "|cffFFFF00" + table[i].Name  + "|cffFFFF00, ";
				break;
		}
    }
