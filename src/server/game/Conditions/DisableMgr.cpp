...
void LoadDisables()
{
    ...
    do
    {
        ...
        switch (type)
        {
            ...
            {
                if (!sCreatureDisplayInfoStore.LookupEntry(entry))
                {
                    sLog->outErrorDb("DisplayId %u from `disables` doesn't exist in dbc, skipped.", entry);
                    continue;
                }
                break;  
            }
            ...
            case DISABLE_TYPE_ITEM:
            {
                ...
                {
                    sLog->outErrorDb("Item entry %u from `disables` doesn't exist in dbc, skipped.", entry);
                    continue;
                }
                break;  
            }
            ...
            case DISABLE_TYPE_NPC:
            {
                ...
                {
                    sLog->outErrorDb("NPC entry %u from `disables` doesn't exist in dbc, skipped.", entry);
                    continue;
                }
                break;  
            }
            ...
            {
                if (!GetAreaEntryByAreaID(entry))
                {
                    sLog->outErrorDb("Zone entry %u from `disables` doesn't exist in dbc, skipped.", entry);
                    continue;
                }
                break;  
            }
