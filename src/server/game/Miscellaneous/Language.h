...
enum TrinityStrings
{
	...
	LANG_CONSOLE_MUTE					= 357,
	LANG_CONSOLE_DELAYED_MUTE			= 358,
	LANG_CONSOLE_BAN					= 359,
	LANG_CONSOLE_PERMABAN				= 360,
    // Room for more level 2              361-399 not used
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_PLAYER_MADE_NPC_SAY            = 11002, //Player %s made npc %s say %s.
    LANG_PLAYER_MADE_NPC_YELL           = 11003, //Player %s made npc %s yell %s.
