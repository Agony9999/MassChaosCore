...
public:
	...
	static bool HandleDetermineNpcSpawn(ChatHandler* handler, const char* args)
    {
        ...
        if (DisableMgr::IsDisabledFor(DISABLE_TYPE_NPC, id, player) && !player->IsAdmin())
        {
    ...
    static bool HandleNpcDeleteCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (DisableMgr::IsDisabledFor(DISABLE_TYPE_ZONE, player->GetZoneId(), player) && !player->IsAdmin())
        {
			handler->SendSysMessage("You cannot delete NPCs in this zone.");
			return true;
        }
    ...
    */
    ...
    static bool HandleNpcSayCommand(ChatHandler* handler, const char* args)
    {
        ...
        sWorld->SendGMText(LANG_PLAYER_MADE_NPC_SAY, handler->GetSession()->GetPlayer()->GetName(), creature->GetName(), args);
    ...
    static bool HandleNpcYellCommand(ChatHandler* handler, const char* args)
    {
        ...
        sWorld->SendGMText(LANG_PLAYER_MADE_NPC_YELL, handler->GetSession()->GetPlayer()->GetName(), creature->GetName(), args);
